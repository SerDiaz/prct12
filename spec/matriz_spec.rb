...
#----------------------------------------------------------
  describe "Fracciones" do
    before :all do
      ...
      @m1[1, 0] = Prct12::Fraccion.new(3, 2)
      @m1[1, 1] = Prct12::Fraccion.new(1, 3)

      @m2[0, 0] = Prct12::Fraccion.new(5, 2)
      @m2[0, 1] = Prct12::Fraccion.new(3, 2)
      @m2[1, 0] = Prct12::Fraccion.new(0, 1)
      @m2[1, 1] = Prct12::Fraccion.new(0, 1)
    end

    it "Suma" do
      @m3[0, 0] = Prct12::Fraccion.new(3, 1)
      @m3[0, 1] = Prct12::Fraccion.new(5, 2)
      @m3[1, 0] = Prct12::Fraccion.new(3, 2)
      @m3[1, 1] = Prct12::Fraccion.new(1, 3)

      (@m1+@m2).should eq(@m3)
    end

    it "Resta" do
      @m3[0, 0] = Prct12::Fraccion.new(-2, 1)
    ...
    it "Comparación" do
      @m3[0, 0] = Prct12::Fraccion.new(5, 2)
      @m3[0, 1] = Prct12::Fraccion.new(3, 2)
      @m3[1, 0] = Prct12::Fraccion.new(0, 1)
      @m3[1, 1] = Prct12::Fraccion.new(0, 3)
...
#-------------------------------------------------------------------------
  describe "Diferentes tipos" do
    ...
    it "Suma" do
      ...
      @m3[1, 1] = Prct12::Fraccion.new(4, 1)
    ...
    it "Multiplicación" do
      @m3[0, 0] = Prct12::Fraccion.new(2, 4)
      @m3[0, 1] = Prct12::Fraccion.new(3, 2)
      @m3[1, 0] = Prct12::Fraccion.new(0, 1)
      @m3[1, 1] = Prct12::Fraccion.new(0, 1)
